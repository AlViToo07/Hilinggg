...
<nav
    ...
    <div class="flex flex-row items-center mr-2">
        ...
        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
            class="text-white bg-violet-600 hover:bg-neutral-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-1 py-1 mx-3 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            type="button">
            <img src="{{ asset('img/' . (auth()->user()->customer->img_profile ?? 'default-profile.jpg') ) }}" alt="" class="w-12 h-12 rounded-full">
        </button>
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                <li>
                    <div href="#"
                        class="block px-4 py-2 text-black w-full">{{ auth()->user()->username }}</div>
                </li>
                <li>
